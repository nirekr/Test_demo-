pipeline {
   ...
   environment {
    ...
    stages {
      ...
      stage("Build") {
            steps {
                sh "mkdir INPUT_FOLDER/zFinal_Report/"
                sh "cp /${WORKSPACE}/INPUT_FOLDER/storage-capabilities-api/nexb-output/storage-capabilities-api.html /INPUT_FOLDER/zFinal_Report/"
sh"cp /${WORKSPACE}/INPUT_FOLDER/virtualization-capabilities-api/nexb-output/virtualization-capabilities-api.html /${WORKSPACE}/INPUT_FOLDER/zFinal_Report/"
